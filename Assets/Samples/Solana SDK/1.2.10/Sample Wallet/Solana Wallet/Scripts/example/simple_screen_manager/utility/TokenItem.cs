...
namespace Solana.Unity.SDK.Example
{
    public class TokenItem : MonoBehaviour
    {
        ...
        public async UniTask InitializeData(TokenAccount tokenAccount, SimpleScreen screen, Solana.Unity.SDK.Nft.Nft nftData = null)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (string.IsNullOrEmpty(tokenDef.TokenName) || string.IsNullOrEmpty(tokenDef.Symbol))
                        return;
        ...
        {
            if (string.IsNullOrEmpty(logoUrl) || string.IsNullOrEmpty(tokenMint) || logo == null)
                return;
